...
err_t init_tss(void) {
    ...
    CHECK_ERROR(tss != NULL, UACPI_STATUS_OUT_OF_MEMORY);
    CHECK_ERROR(ist1 != NULL, UACPI_STATUS_OUT_OF_MEMORY);
    CHECK_ERROR(ist2 != NULL, UACPI_STATUS_OUT_OF_MEMORY);
    CHECK_ERROR(ist3 != NULL, UACPI_STATUS_OUT_OF_MEMORY);
    CHECK_ERROR(ist4 != NULL, UACPI_STATUS_OUT_OF_MEMORY);
    CHECK_ERROR(ist5 != NULL, UACPI_STATUS_OUT_OF_MEMORY);
    CHECK_ERROR(ist6 != NULL, UACPI_STATUS_OUT_OF_MEMORY);
    CHECK_ERROR(ist7 != NULL, UACPI_STATUS_OUT_OF_MEMORY);
